...
return [
    ...
    'A password will be generated automatically if not provided' => 'Leer lassen, um automatisch ein Kennwort zu generieren',
    ...
    'An email with instructions to create a new password has been sent to {email} if it is associated with an {appName} account. Your existing password has not been changed.' => 'Eine E-Mail mit Hinweisen, wie ein Kennwort erstellt oder geändert wird, wurde an <strong>{email}</strong> gesendet, sofern es mit dem Konto <strong>{appName}</strong> verbunden ist. Das aktuelle Kennwort wurde nicht geändert.',
    ...
    'Are you sure you wish to send a password recovery email to this user?' => 'Sind Sie sicher, dass Sie eine E-Mail zur Kennwortwiederherstellung an diesen Benutzer senden möchten?',
    ...
    'Class' => 'Klasse',
    'Close' => 'schließen',
    'Complete password reset on {0}' => 'Kennwort-Wiederherstellung auf {0} fertigstellen',
    'Confirm' => 'Bestätigen',
    ...
    'Current password is not valid' => 'Das aktuelle Kennwort ist nicht korrekt',
    ...
    'Invalid login or password' => 'Falscher Login oder falsches Kennwort',
    ...
    'Last password change' => 'Letzte Kennwortänderung',
    'Location' => 'Ort',
    'Login' => 'Anmelden',
    'Logout' => 'Abmelden',
    ...
    'Password has been changed' => 'Ihr Kennwort wurde geändert',
    'Permissions' => 'Berechtigungen',
    'Please be certain' => 'Sind Sie sich wirklich sicher?',
    'Please click the link below to complete your password reset' => 'Bitte klicken Sie auf den folgenden Link, um das Zurücksetzen Ihres Kennworts abzuschließen',
    ...
    'Send password recovery email' => 'Sende Mail zur Kennwortwiederherstellung',
    'Sign in' => 'Anmelden',
    ...
    'We have generated a password for you' => 'Ein Kennwort wurde für Sie generiert',
    ...
    'We have received a request to reset the password for your account on {0}' => 'Wir haben eine Anfrage, ihr Kennwort auf {0} wiederherzustellen, bekommen',
    ...
    'Your password has expired, you must change it now' => 'Ihr Kennwort ist abgelaufen, Sie müssen es jetzt ändern',
