    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'email')->hint(Yii::t('app', 'can be used for CSC API requests')) ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myModalLabel"><?= Yii::t('usuario', 'Two Factor Authentication (2FA)') ?></h5>
                ...
                <div class="panel-body">
                    ...
                    <div class="float-right">
                        ...
                        <?= Html::a(
                            ...
                            [
                                'id' => 'enable_tf_btn',
                                'class' => 'btn btn-info ' . ($model->getUser()->auth_tf_enabled ? 'd-none' : ''),
                                'data-toggle' => 'modal',
                                'data-target' => '#tfmodal'
                            ]
                        ) ?>
