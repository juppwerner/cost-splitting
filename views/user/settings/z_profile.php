    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= '' // $form->field($model, 'public_email')->hint(Yii::t('app', 'can be used for CSC API requests')) ?>

                <?= '' // $form->field($model, 'website') ?>

                <?= $form->field($model, 'location') ?>

                <?= $form->field($model, 'phoneNbr')->hint(Yii::t('app', 'can be used for CSC API requests')) ?>

                <?= $form->field($model, 'cscApiEmail')->hint(Yii::t('app', 'will receive CSC API TLS request verification emails')) ?>
